...
{
    [TestClass]
    public class SonarQubeService_GetVulnerabilitesAsync : SonarQubeService_TestBase
    {
        [TestMethod]
        public async Task GetVulnerabilitiesIssuesAsync_From_7_20()
        {
...
");
            ...
            var result = await service.GetVulnerabilitiesAsync("shared", CancellationToken.None);
